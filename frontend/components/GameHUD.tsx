  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      <div className="rounded-lg border border-white/20 bg-black p-4">
        <h3 className="text-sm uppercase tracking-widest text-zinc-300">Player</h3>
      ...
      <div className="rounded-lg border border-white/20 bg-black p-4">
        <h3 className="text-sm uppercase tracking-widest text-zinc-300">Enemy</h3>
        <p className="mt-2 text-lg font-semibold text-white">{enemyName}</p>
        <div className="mt-4 space-y-3">
